...
class OAuthSimple {
     ...
     * @param  string $consumer_secret The shared secret. This value is also usually provided by the site you wish to use.
     * @return OAuthSimple
     */
    function __construct ($APIKey = "", $consumer_secret=""){
        ...
        {
            $this->_secrets['consumer_secret'] = $consumer_secret;
        }
     ...
     *
     * @access public
     * @param string|array|object $parameters List of parameters for the call, this can either be a URI string (e.g. "foo=bar&gorp=banana" or an object/hash)
     * @return OAuthSimple
     */
     ...
     *
     * @param $signatures (object) object/hash of the token/signature pairs {api_key:, consumer_secret:, oauth_token: oauth_secret:}
     * @return OAuthSimple
     * @throws OAuthSimpleException
     */
    public function signatures ($signatures)
    {
        ...
        if (empty($this->_secrets['consumer_secret']))
        {
            throw new OAuthSimpleException('Missing requires consumer_secret in OAuthSimple.signatures');
        }
    ...
    private function _getNonce($length = 15)
    {
        $result = '';
    ...
    {
        $secretKey = '';
        if(isset($this->_secrets['consumer_secret']))
        {
            $secretKey = self::_oauthEscape($this->_secrets['consumer_secret']);
        }
